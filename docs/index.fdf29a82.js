...
startBlock = function(e) {
    if (e.key === "a") col1StartBlock();
    if (e.key === "s") col2StartBlock();
    if (e.key === "d") col3StartBlock();
    if (e.key === "f") col4StartBlock();
};
endBlock = function(e) {
    if (e.key === "a") col1EndBlock();
    if (e.key === "s") col2EndBlock();
    if (e.key === "d") col3EndBlock();
    if (e.key === "f") col4EndBlock();
};
...
},{}]},["jLWiq","1SICI"], "1SICI", "parcelRequire8ffb")
